...
- (void)viewDidLoad {
    ...
    if ([_delegate respondsToSelector:@selector(PAPasscodeViewControllerDidCancel:)]) {
        if (_simple) {
            self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"Fingerprint"] landscapeImagePhone:nil style:UIBarButtonItemStylePlain target:self action:@selector(cancel:)];
            ...
            self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"My Notes"] landscapeImagePhone:nil style:UIBarButtonItemStylePlain target:self action:nil];
